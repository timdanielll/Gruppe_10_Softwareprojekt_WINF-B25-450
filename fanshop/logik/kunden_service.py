"""Geschaeftslogik rund um Kunden (/F41/ bis /F44/, /F52/)."""
...
class KundenService:
    ...
    def __init__(self, kunden_repository: KundenRepository) -> None:
    ...
    def sticker_album(self, kundennummer: int) -> dict[str, int]:
        """Welche Stickermotive besitzt der Kunde und wie oft (/F53/)?"""
